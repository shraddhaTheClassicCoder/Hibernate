...
public class HibernateUtilDb2 {
	...
	private HibernateUtilDb2() {
		// Making constructor private so no one can create object of it outside of the
		// class
	}

	static {
		sessionFactory = new Configuration().configure("in/ineuron/config/hibernate.cfg_Db2.xml").addAnnotatedClass(Product.class).buildSessionFactory();
